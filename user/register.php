...
if($error_message ==""){
	$sql = "INSERT INTO user_table (user_fname, user_lname, user_dob, user_gender, user_dor, user_email, user_password, user_phone) VALUES(?,?,?,?,?,?,?,?)"; 
	$statement = $con->prepare($sql);
	$statement->bind_param("ssssssss", $fname, $lname, $dob, $gender, $dor, $email, $password, $phone);
